...
public class MainWindowA extends javax.swing.JFrame {
    ...
    private void startGame() {
        ...
        //soundManager.playBackgroundMusic("src/assets/tetris_music.wav"); // Iniciar la música, quitado en linux
    ...
    public void showGameOver() {
        ...
        game = null;
        //soundManager.stopMusic(); // Detener la música cuando termina el juego, quitado en linux
